...
public class PasswordChecker extends JFrame implements ActionListener {
    ...
    private final JLabel iconLabel2;
    private final JLabel iconLabel3;
    private final JLabel iconLabel4;
    private final JLabel iconLabel5;
    
    private final JLabel iconLabelShow;
    private final JLabel iconLabelHide;
       
    // Image Icons   
    private ImageIcon showIcon = new ImageIcon("show.png");
    private ImageIcon hideIcon = new ImageIcon("hide.png");
    
    private final ImageIcon greenIcon = new ImageIcon("green.png");
    private final ImageIcon redIcon = new ImageIcon("red.png");
